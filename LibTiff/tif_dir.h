...
#define	FIELD_SETLONGS	4
	...
	uint32		td_nModelPixelScaleLength; /* should be 3 */
	double *	td_pModelPixelScale;
	uint32		td_nModelTiePointLength; /* should be multiply 6 */
	double *	td_pModelTiePoint;
	uint32		td_nModelTransformationLength; /* should be 16 */
	double *	td_pModelTransformation;
	uint32		td_nGeoKeyDirectoryLength;
	short *		td_pGeoKeyDirectory;
	uint32		td_nGeoDoubleParamsLength;
	double *	td_pGeoDoubleParams;
	uint32		td_nGeoAsciiParamsLength;
	char *		td_pGeoAsciiParams;
	uint32		td_nRpcLength;
	double *	td_pRpc;
#endif //AUX_TIFF_GEO
} TIFFDirectory;
...
#ifdef AUX_TIFF_GEO	//add geotiff tags
#define FIELD_MODEL_PIXEL_SCALE		67
#define FIELD_MODEL_TIE_POINT		68
#define FIELD_MODEL_TRANSFORMATION	69
#define FIELD_GEO_KEY_DIRECTORY		70
#define FIELD_GEO_DOUBLE_PARAMS		71
#define FIELD_GEO_ASCII_PARAMS		72
#define FIELD_RPC					73
#endif //AUX_TIFF_GEO
