...
#define TIFFTAG_MODEL_PIXEL_SCALE		   33550
#define TIFFTAG_MODEL_TIE_POINT			   33922	
#define TIFFTAG_MODEL_TRANSFORMATION	   34264	
#define TIFFTAG_GEO_KEY_DIRECTORY		   34735
#define TIFFTAG_GEO_DOUBLE_PARAMS		   34736	
#define TIFFTAG_GEO_ASCII_PARAMS		   34737
#define TIFFTAG_RPC							50844
...
enum ProjLinearUnitsGeoKeyValues
{
   Linear_Meter							=	9001,
   Linear_Foot							=	9002,
...
enum GeogAngularUnitsGeoKeyValues
{
   Angular_Radian						=	9101,
   Angular_Degree						=	9102,
   ...
   Angular_Micro_Radian					=	9109,
};

enum ProjCoordTransGeoKeyValues
{
