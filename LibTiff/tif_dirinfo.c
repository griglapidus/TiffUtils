...
#ifdef AUX_TIFF_GEO	//set field_oktochange to 1
     1,	1,	"XMLPacket" },
#else //AUX_TIFF_GEO
     0,	1,	"XMLPacket" },
#endif //AUX_TIFF_GEO
...
/* end Pixar tags */
    ...
    { TIFFTAG_MODEL_PIXEL_SCALE, 3, 3, TIFF_DOUBLE,	FIELD_MODEL_PIXEL_SCALE,
      FALSE,	TRUE,	"ModelPixelScale" },
#endif //AUX_TIFF_GEO
    { TIFFTAG_RICHTIFFIPTC, -3, -3,	TIFF_UNDEFINED,	FIELD_CUSTOM, 
      0,    1,   "RichTIFFIPTC" },
#ifdef AUX_TIFF_GEO	//add geotiff tags
    { TIFFTAG_MODEL_TIE_POINT, -1, -1, TIFF_DOUBLE,	FIELD_MODEL_TIE_POINT,
      FALSE,	TRUE,	"ModelTiePoint" },
    { TIFFTAG_MODEL_TRANSFORMATION, 16, 16, TIFF_DOUBLE,	FIELD_MODEL_TRANSFORMATION,
      FALSE,	TRUE,	"ModelTransformation" },
#endif //AUX_TIFF_GEO
    ...
    { TIFFTAG_ICCPROFILE,	-3, -3,	TIFF_UNDEFINED,	FIELD_CUSTOM,
      0,	1,	"ICC Profile" },
#ifdef AUX_TIFF_GEO	//add geotiff tags
    { TIFFTAG_GEO_KEY_DIRECTORY, -1, -1, TIFF_SHORT,	FIELD_GEO_KEY_DIRECTORY,
      FALSE,	TRUE,	"GeoKeyDirectory" },
    { TIFFTAG_GEO_DOUBLE_PARAMS, -1, -1, TIFF_DOUBLE,	FIELD_GEO_DOUBLE_PARAMS,
      FALSE,	TRUE,	"GeoDoubleParams" },
    { TIFFTAG_GEO_ASCII_PARAMS, -1, -1, TIFF_ASCII,	FIELD_GEO_ASCII_PARAMS,
      FALSE,	TRUE,	"GeoAsciiParams" },
    { TIFFTAG_RPC, -1, -1, TIFF_DOUBLE,	FIELD_RPC,
      FALSE,	TRUE,	"RPC" },
#endif //AUX_TIFF_GEO
...
_TIFFSetupFieldInfo(TIFF* tif, const TIFFFieldInfo info[], size_t n)
{
	...
	_TIFFMergeFieldInfo(tif, info, (int)n);
}
...
static int
tagNameCompare(void* pvlocale, const void* a, const void* b)
{
	const TIFFFieldInfo* ta = *(const TIFFFieldInfo**) a;
	const TIFFFieldInfo* tb = *(const TIFFFieldInfo**) b;
